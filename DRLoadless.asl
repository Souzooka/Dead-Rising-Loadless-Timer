...
startup
{
	...
	settings.Add("caseSplits", true, "Split on Case End (all cases)");
	
	settings.Add("case1", true, "Case 1 Splits");
	settings.Add("prologue", false, "Prologue", "case1");
	
	settings.Add("case2", true, "Case 2 Splits");
	settings.Add("steven", true, "Steven", "case2");
	settings.Add("firstaid", false, "First Aid", "case2");
	
	settings.Add("case7", true, "Case 7 Splits");
